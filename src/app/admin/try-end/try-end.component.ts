...
@Component({
    selector: 'app-admin-try-end',
    templateUrl: './try-end.component.html',
    styleUrls: [
        './try-end.component.scss'
    ]
})
export class AdminTryEndComponent implements OnInit {
    public tries = [];
    public env: any;
    public total: any;
    public filter = {
    ...
    getTries() {
        ...
        this.api.all('tries').customGET('getTriesEnd',
            {
